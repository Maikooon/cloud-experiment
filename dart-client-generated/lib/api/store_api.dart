...
class StoreApi {
  ...
  Future<Order> placeOrder({ Order body }) async {
    ...
    if(contentType.startsWith("multipart/form-data")) {
      ...
      if (petId != null) {
        hasFields = true;
        mp.fields['petId'] = parameterToString(petId);
      }
      if (quantity != null) {
        hasFields = true;
        mp.fields['quantity'] = parameterToString(quantity);
      }
      if (shipDate != null) {
        hasFields = true;
        mp.fields['shipDate'] = parameterToString(shipDate);
      }
      if (status != null) {
        hasFields = true;
      ...
      if (complete != null) {
        hasFields = true;
        mp.fields['complete'] = parameterToString(complete);
      }
      if(hasFields)
        postBody = mp;
    }
...
if (petId != null)
        formParams['petId'] = parameterToString(petId);
if (quantity != null)
        formParams['quantity'] = parameterToString(quantity);
if (shipDate != null)
        formParams['shipDate'] = parameterToString(shipDate);
if (status != null)
        formParams['status'] = parameterToString(status);
if (complete != null)
        formParams['complete'] = parameterToString(complete);
    }
